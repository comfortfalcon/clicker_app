...
<body>
	 ...
	 <form action="managequestions.php"  method="post"
					novalidate="">
							<label for="email"> Add Question: </label>
							<input type="text" name="email" id="email" required="required">
						
							<br>
						
							<label for="password"> Add Answer: </label>
...
function makeid()
{
    ...
    window.location.href = "http://http://derekanesmith.com/managequestions.php?name=" + text;
    return text;
}
</script>
<?php
